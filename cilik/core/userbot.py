...
class Userbot(Client):
    ...
    async def start(self):
        ...
        if config.STRING1:
            ...
            try:
                await self.one.join_chat("CilikStoree")
                await self.one.join_chat("botlogsid")
                await self.one.join_chat("CilikSupport")
            except:
                pass
            assistants.append(1)
            try:
        ...
        if config.STRING2:
            ...
            try:
                await self.two.join_chat("CilikStoree")
        ...
        if config.STRING3:
            ...
            try:
                await self.three.join_chat("CilikStoree")
        ...
        if config.STRING4:
            ...
            try:
                await self.four.join_chat("CilikStoree")
        ...
        if config.STRING5:
            ...
            try:
                await self.five.join_chat("CilikStoree")
        ...
        if config.STRING6:
            ...
            try:
                await self.six.join_chat("CilikStoree")
        ...
        if config.STRING7:
            ...
            try:
                await self.seven.join_chat("CilikStoree")
        ...
        if config.STRING8:
            ...
            try:
                await self.eight.join_chat("CilikStoree")
        ...
        if config.STRING9:
            ...
            try:
                await self.nine.join_chat("CilikStoree")
        ...
        if config.STRING10:
            ...
            try:
                await self.ten.join_chat("CilikStoree")

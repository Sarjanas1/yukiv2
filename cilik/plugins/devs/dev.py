...
from cilik.utils.database.memorydatabase import get_active_chats
from cilik.utils.database.memorydatabase import get_active_video_chats
from cilik.utils.database.mongodatabase import get_served_chats
...
@cilik.on_callback_query(filters.regex(r"runtime"))
async def runtime_func_cq(_, cq):
    runtime = cq.data.split(None, 1)[1]
    await cq.answer(runtime, show_alert=True)


@cilik.on_callback_query(filters.regex("forceclose"))
...
async def link_cmd(client, message):
    ...
    data = await cilik.export_chat_invite_link(id)

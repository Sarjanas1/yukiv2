...
from cilik import (Apple, Resso, SoundCloud, Spotify, Telegram,
                     YouTube, cilik)
from cilik.core.call import Yukki
from cilik.utils import seconds_to_min, time_to_seconds
from cilik.utils.channelplay import get_channeplayCB
from cilik.utils.database import is_video_allowed
from cilik.utils.decorators.language import languageCB
from cilik.utils.decorators.play import PlayWrapper
#from cilik.utils.decorators.grey import subcribe

from cilik.utils.formatters import formats
from cilik.utils.inline.play import (livestream_markup,
                                       playlist_markup,
                                       slider_markup, track_markup)
from cilik.utils.inline.playlist import botplaylist_markup
from cilik.utils.logger import play_logs
from cilik.utils.stream.stream import stream
    ...
    if audio_telegram:
        ...
        if await YouTube.exists(url):
            ...
            try:
                ...
                return await cilik.send_message(
                    config.LOG_GROUP_ID,
...
@cilik.on_callback_query(filters.regex("MusicStream") & ~BANNED_USERS)
@languageCB
...
@cilik.on_callback_query(filters.regex("slider") & ~BANNED_USERS)
@languageCB

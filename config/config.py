...
# Your User ID.
OWNER_ID = list(
    map(int, getenv("OWNER_ID", "1847951124 1784606556 966484444").split())
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/CilikProject/asud",
)
...
)  # Example:- https://t.me/khenjiz
SUPPORT_GROUP = getenv(
    "SUPPORT_GROUP", None
)  # Example:- https://t.me/NpDkSupport
